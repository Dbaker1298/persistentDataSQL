...
// Define inMemoryRepo type to represent in memory repository
// Implement all methods of pomodoro.Repository interface
type inMemoryRepo struct {
	sync.RWMutex
	intervals []pomodoro.Interval
}

// No exported fields here, ensures that callers can only access it through
// the exported methods that compose the Repository interface, guaranteeing data consistency
